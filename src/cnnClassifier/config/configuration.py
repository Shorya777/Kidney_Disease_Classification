...
class ConfigurationManager:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig: #Tells that this function is only responsible for returning value specified in DataIngestionConfig
